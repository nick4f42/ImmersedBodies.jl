...
function B_linearmap(bodies::BodyGroup{<:AbstractPrescribedBody}, B_times::B_Times)
...
function Binv_linearmap(prob::Problem{<:PsiOmegaFluidGrid,<:AbstractPrescribedBody}, B)
    nftot = 2 * npanels(prob.bodies)
